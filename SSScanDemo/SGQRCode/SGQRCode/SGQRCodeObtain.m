...
- (void)establishAuthorizationQRCodeObtainAlbumWithController:(UIViewController *)controller {
    ...
    if (device) {
        ...
        if (status == PHAuthorizationStatusNotDetermined) { // 用户还没有做出选择
            ...
            UIAlertController *alertC = [UIAlertController alertControllerWithTitle:@"无法获取权限" message:@"请在手机的 “设置-隐私-照片”选项中，允许访问你的照片权限。" preferredStyle:(UIAlertControllerStyleAlert)];
